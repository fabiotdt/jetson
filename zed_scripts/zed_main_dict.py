...
def displayer(zed, screen_width, screen_height, viewer, image_L, image_R, point_cloud, res):
...
def main():
    ...
    screen_w = int(glutGet(GLUT_SCREEN_WIDTH))
    screen_h = int(glutGet(GLUT_SCREEN_HEIGHT))
    ...
    while viewer.is_available():
        ...
        if zed.grab(runtime_parameters) == sl.ERROR_CODE.SUCCESS:
            ...
            displayer(zed, screen_w, screen_h, viewer, image_L, image_R, point_cloud, res)
